...
export { default as BaseBulkFailures } from '@/shared/ui/BaseBulkFailures/BaseBulkFailures.vue'
...
export type { BulkFailureItem } from '@/shared/ui/BaseBulkFailures/BaseBulkFailures.vue'
export type { SelectOption } from '@/shared/ui/BaseSelect/BaseSelect.vue'
export type { SegmentedOption } from '@/shared/ui/BaseSegmentedControl/BaseSegmentedControl.vue'
export type { TableColumn, TableViewMode } from '@/shared/ui/BaseDataTable/types'
